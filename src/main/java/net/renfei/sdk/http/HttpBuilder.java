...
public class HttpBuilder extends HttpClientBuilder {
    ...
    public HttpBuilder timeout(int connectTimeout, int socketTimeout, int connectionRequestTimeout) {
        ...
        RequestConfig requestConfig = RequestConfig.custom()
                ...
                .build();
        return (HttpBuilder) this.setDefaultRequestConfig(requestConfig);
    }
     ...
     * @return
     */
    public HttpBuilder timeout(int timeout) {
        RequestConfig requestConfig = RequestConfig.custom()
                //从连接池中获取连接的超时时间
     ...
     * @return
     */
    public HttpBuilder pool(int maxTotal, int maxPerRoute, int maxRoute, String hostname, int port) {
        ...
        return (HttpBuilder) this.setConnectionManager(cm);
    }
     ...
     * @return
     */
    public HttpBuilder pool(int maxTotal, int maxPerRoute) {
        ConnectionSocketFactory plainsf = PlainConnectionSocketFactory
                .getSocketFactory();
        LayeredConnectionSocketFactory sslsf = SSLConnectionSocketFactory
                .getSocketFactory();
    ...
    public HttpBuilder retry(final int tryTimes, final boolean retryWhenInterruptedIO) {
        ...
        return (HttpBuilder) this.setRetryHandler(httpRequestRetryHandler);
    }
    ...
    public HttpBuilder ssl() {
        return (HttpBuilder) this.setSSLSocketFactory(createSSLConnSocketFactory());
    }
