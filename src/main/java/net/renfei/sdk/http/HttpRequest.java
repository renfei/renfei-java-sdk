...
public class HttpRequest {
     ...
     * @return 返回当前对象
     */
    public HttpRequest out(OutputStream out) {
        outs.set(out);
        return this;
    }
     ...
     * @return 返回当前对象
     */
    public HttpRequest headers(Map<String, Header> headerMap) {
     ...
     * @return 返回当前对象
     */
    public HttpRequest requestMethod(HttpRequestMethod requestMethod) {
     ...
     * @return 返回当前对象
     */
    public HttpRequest context(HttpContext context) {
     ...
     * @return 返回当前对象
     */
    public HttpRequest paramMap(Map<String, Object> paramMap) {
     ...
     * @return
     */
    public HttpRequest requestCharset(String requestCharset) {
